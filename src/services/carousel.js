...
class Carousel extends Component {
	...
	render() {
		const {children, autoPlayInterval, switcher, indicator, transitionDuration, transitionTimingFunction, slideWillChange, slideDidChange, } = this.props;
		...
		return (
			<div {...this.props} style={Object.assign({}, this.props.style, {
				position: 'relative',
				overflowX: 'hidden',
