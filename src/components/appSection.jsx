                ...
                <div className="col-sm-6 col-md-7">
                  <div className="container-fluid">
                    ...
                    <div className="row download-style">
                      <h3>Download Now</h3>
                      <div className="col-xs-4"><img src={server} className="img-90 max-width-100"/></div>
                      <div className="col-xs-4"><img src={apple} className="img-90 max-width-100"/></div>
                      <div className="col-xs-4"><img src={windows} className="img-90 max-width-100"/></div>
                    </div>
                  </div>
                </div>
