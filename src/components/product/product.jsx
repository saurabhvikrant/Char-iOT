     ...
     <div className="container">
        <div className="row">
           <div className="products-heading col-md-12 wow fadeInUp">
              ...
              <p>NRS Chariot Tech Pvt. Ltd. is an Indian start-up providing end-to-end internet of things (IoT) and M2M solutions.
                 We at our innovation lab develop smart IoT based solutions bring.
              </p>
